...
export function TripSummaryScreen({ onNavigate, accommodationSkipped }: TripSummaryScreenProps) {
  // Données gagnantes
  const winningFlight = {
    airline: 'Air France',
    logo: '✈️',
          ...
          <div className="bg-gradient-to-r from-gray-50 to-slate-50 rounded-2xl p-5 border-2 border-gray-200">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-[#4ECDC4] text-xl">{winningFlight.price + (accommodationSkipped ? 0 : winningAccommodation.pricePerNight * winningAccommodation.totalNights)}€</span>
              </div>
            </div>
          </div>
        </div>
